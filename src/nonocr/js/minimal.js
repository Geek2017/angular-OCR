...
window.onload = function () {
    var pdfBase64 = this.localStorage.getItem('PDFbase64').replace("data:application/pdf;base64,","").replace("data:image/jpeg;base64,","").replace("data:image/png;base64,","");
    ...
    //     console.log('!ocr')
    //     var content=$('.textLayer').text().length
    //     console.log('Length:',$('.textLayer').text().length)
    
    // if(content>0){
    //  localStorage.setItem('setstat','0'); 
    //     }else{
    //  localStorage.setItem('setstat','1');   
    //  console.log('ocr')
    //     }
    // }, 1000);
